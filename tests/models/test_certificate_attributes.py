...
@pytest.mark.parametrize('distinguished_name, expected_certificate_attribute', [
    (
...
def test_from_distinguished_name(distinguished_name, expected_certificate_attribute):
    certificate_attribute = CertificateAttributes.from_distinguished_name(distinguished_name)
    assert certificate_attribute == expected_certificate_attribute
