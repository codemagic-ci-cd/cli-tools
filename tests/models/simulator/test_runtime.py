...
@pytest.mark.parametrize(
    "raw_runtime_name, expected_runtime_version",
    [
...
@pytest.mark.parametrize(
    "raw_runtime_name, expected_runtime_name",
    [
        ...
        ("com.apple.CoreSimulator.SimRuntime.xrOS-1-0", "visionOS"),
        ("iOS 13.2", "iOS"),
...
@pytest.mark.parametrize(
    "raw_runtime_name, expected_pretty_name",
    [
        ...
        ("com.apple.CoreSimulator.SimRuntime.xrOS-1-0", "visionOS 1.0"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "com.apple.CoreSimulator.SimRuntime.tvOS-14-0-2",
            Runtime("com.apple.CoreSimulator.SimRuntime.tvOS-14-0-2"),
            True,
        ),
        ...
        (Runtime("xrOS-1-0"), "visionOS 1.0", True),
