...
- `app-store-connect publish` action accepts multiple Beta group names under `--beta-groups` key. The uploaded TestFlight build will be made available to the specified groups of beta testers.
