...
|[`get-latest-build-number`](get-latest-build-number.md)|Find the highest build number used for given app considering both TestFlight and App Store submissions|
