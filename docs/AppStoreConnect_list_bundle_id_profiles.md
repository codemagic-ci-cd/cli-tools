...
Alphanumeric ID value of the Bundle ID. Type `ResourceId`. Multiple arguments
...
Type of the provisioning profile. Type `ProfileType`

**--state={ACTIVE, INVALID}**

State of the provisioning profile. Type `ProfileState`
