...
**Manage APK deobfuscation files in Google Play**
### Usage
```bash
google-play deobfuscation-files [-h] [--log-stream STREAM] [--no-color] [--version] [-s] [-v]
...
|Action|Description|
| :--- | :--- |
|[`upload`](deobfuscation-files/upload.md)|Upload a new deobfuscation file and attach it to the specified APK.|
